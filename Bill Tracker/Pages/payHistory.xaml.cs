...
{
//TODO: figure out why PostAll Doesnt work.
    public sealed partial class payHistory : Page
    {
        ...
        private async void BttnBillDel_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (action.Id.ToString() == "1")
            {
                ...
                this.Frame.Navigate(typeof(payHistory));
            }
        }
        ...
        private void BttnBillMo_Click(object sender, RoutedEventArgs e)
        {
            histList.SelectedItem = null;
            if (bttnBillMo.IsChecked == true)
            {
                bttnBillBiMo.IsChecked = false;
                bttnBillWkly.IsChecked = false;
                bttnBillAnn.IsChecked = false;
        ...
        private void BttnBillBiMo_Click(object sender, RoutedEventArgs e)
        {
            histList.SelectedItem = null;
            if (bttnBillBiMo.IsChecked == true)
            {
                bttnBillMo.IsChecked = false;
                bttnBillWkly.IsChecked = false;
                bttnBillAnn.IsChecked = false;
        ...
        private void BttnBillWkly_Click(object sender, RoutedEventArgs e)
        {
            histList.SelectedItem = null;
            if (bttnBillWkly.IsChecked == true)
            {
                bttnBillBiMo.IsChecked = false;
                bttnBillMo.IsChecked = false;
                bttnBillAnn.IsChecked = false;
        ...
        private void BttnBillAnn_Click(object sender, RoutedEventArgs e)
        {
            histList.SelectedItem = null;
            if (bttnBillAnn.IsChecked == true)
            {
                bttnBillBiMo.IsChecked = false;
                bttnBillWkly.IsChecked = false;
                bttnBillMo.IsChecked = false;
